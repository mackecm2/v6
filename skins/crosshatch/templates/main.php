...
fbq('init', '1014197705338965');
fbq('track', "PageView");</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1014197705338965&ev=PageView&noscript=1"
/></noscript>
...
<div id="header">
	<div class="headerContainer">
		...
		<a href="" class="headerLogo"><img src="{$ROOT_PATH}skins/crosshatch/images/wymertitle.png" alt="Wymer UK Online Store"/></a>
		{$SITE_DOCS}
...
<div id="content">
	<div class="contentLeft">
		 {$SESSION} {if isset($POPULAR_PRODUCTS)}{$POPULAR_PRODUCTS}{/if} 
	</div>
	...
	<div class="contentRight">
		 {$SHOPPING_CART} {$MAIL_LIST} {$RANDOM_PROD} {$SALE_ITEMS}
	</div>
	<div class="clear">
		&nbsp;
	</div>
